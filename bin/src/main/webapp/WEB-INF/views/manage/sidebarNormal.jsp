        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">내 프로그램</span>
              <i class="menu-arrow"></i>
            </a>
            
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">일반 프로그램</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">트레이너 프로그램</a></li>
              </ul>
            </div>
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/basic-table.html">
              ...
              <span class="menu-title">찜 내역 보기</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/basic_elements.html">
              ...
              <span class="menu-title">내 결제 내역</span>
            </a>
          </li>
