				...
				<div class="row w-100 mx-0">
					<div class="col-lg-4 mx-auto">
						<div class="auth-form-light text-left py-5 px-4 px-sm-5">
							...
							<form action="companymemberjoin" class="pt-3" name="companyjoin"
								id="companyjoin" method="post">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<button type="button" id="numCheck"
											class="btn btn-outline-secondary btn-md">번호 확인</button>
								...
								<div class="form-group">
									<div class="input-group">
										...
										<button type="button" id="idCheck"
											class="btn btn-outline-secondary btn-md" disabled="disabled">중복 확인</button>
									</div>
								</div>
									<div class="form-group">
									<div class="input-group">
								...
								<div class="form-group">
									<div class="input-group">
										<input type="text" name="c_bname" id="c_bname"
											class="form-control form-control-lg border-left-0"
											placeholder="업체명">
									</div>
								</div>
