	...
	<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		<div class="navbar-brand-wrapper d-flex justify-content-center">
			<div
				...
				<a class="navbar-brand brand-logo" href="${pageContext.request.contextPath}/" style="color: #71c016;"><img alt ="logo" src="resources/img/logo.jpg" style="width:100%;height:100%"></a> 
