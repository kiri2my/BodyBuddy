...
<body>
    <div class="tabbable">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#tab1" data-toggle="tab">일반회원</a>
            </li>
            <li>
                <a href="#tab2" data-toggle="tab">프로그램</a>
            </li>
            <li>
                <a href="#tab3" data-toggle="tab">트레이너</a>
            </li>
        </ul>
                                ...
                                <th>
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#">결근</a>
                                            <a class="dropdown-item" href="#">휴무</a>
