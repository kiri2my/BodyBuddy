...
<body>
	...
	<div class="container-scroller">
		...
		<div class="col-md-10 grid-margin grid-margin-md-0 stretch-card">
	<form action="reviewwriteinsert" method="post">
			<div class="card">
				<div class="card-body">
  ...
  <span class="input">
    ...
    <input type="radio" name="rv_stpoint" id="p2" value=1 /><label for="p2">1</label>

    <input type="radio" name="rv_stpoint" id="p4" value=2 /><label for="p4">2</label>

    <input type="radio" name="rv_stpoint" id="p6" value=3 /><label for="p6">3</label>

    <input type="radio" name="rv_stpoint" id="p8" value=4 /><label for="p8">4</label>

    <input type="radio" name="rv_stpoint" id="p10" value=5 /><label for="p10">5</label>
  </span>
