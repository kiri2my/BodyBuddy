												...
												<div
													...
													<li class="nav-item nav-search d-none d-lg-block w-100">
														<div class="input-group">
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span
																class="input-group-text" id="addrSearch"> <input
						...
						<div class="col-md-12 stretch-card">
							...
							<div class="card">
								<div class="card-body">
									...
									<div id="map" style="width: 300px; height: 300px; margin-top: 10px; display: none">나오는곳</div>
...
<script
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f321e26e149ff9c8fec71aba7e8aa47c&libraries=services"></script>
<script>
