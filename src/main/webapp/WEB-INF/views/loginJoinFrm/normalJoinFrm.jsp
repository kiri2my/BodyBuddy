        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="normalmemberjoin" class="pt-3" name="memberjoin" id="memberjoin"
			method="post">
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="tel"  name="m_phone" id="m_phone" class="form-control form-control-lg border-left-0" placeholder="전화번호를 입력해주세요">
                  </div>
                </div> 
