...
public class KirimService {
	...
	public ModelAndView access(Member mb) {
		...
		if (checkId != null) {
			...
			System.out.println("탈퇴아이디 반환 성공?");
			return mav;
		}
...
<<<<<<< HEAD
	...
	private String makeHTMLCompanyProfile(HashMap<String, String> pc, List<HashMap<String, String>> pco) {
		...
		sb.append("<div class=\"main-panel\" style=\"width: 100%\">\r\n"
				...
				+ "                                            <img src='" + pc.get("PF_IMAGE")
				+ "' alt=\"detailImage\" class=\"img-rounded\" />\r\n"
				+ "                                        </a>\r\n" + "                                    </div>\r\n"
				+ "                                </div>\r\n" + "                            </div>\r\n"
				+ "                        </div>\r\n"
				...
				+ pc.get("C_BNAME") + "</h2>\r\n"
				+ "                                        <h3><small class=\"text-muted\" >" + pc.get("M_ADDR")
				+ "</small></h3>\r\n" + "                                        <br>\r\n"
				+ "                                        <h4 class=\"display-4\">Phone : " + pc.get("C_BPHONE")
				+ "</h4>\r\n" + "                                        <h4 class=\"display-4\">Representative : "
				+ pc.get("M_NAME") + "</h4>\r\n"
				+ "                                        <h4 class=\"display-4\">Business Number : " + pc.get("C_NUM")
				+ "</h4>\r\n" + "                                        <br>\r\n"
				+ "                                        <address class=\"text-primary\">\r\n"
				+ "                                            <p class=\"font-weight-bold\">E-mail</p><p class=\"mb-2\">"
				+ pc.get("M_ID") + "</p>"
				+ "                                            <p class=\"font-weight-bold\">Personal-phone</p><p class=\"mb-2\">"
				+ pc.get("M_PHONE") + "</p>" + "                                        </address>\r\n"
				+ "                                    </div>\r\n" + "                                </div>\r\n"
				+ "                            </div>\r\n" + "                        </div>\r\n"
				+ "                    </div>\r\n" + "                    <div class=\"row\">\r\n"
		...
		for (int i = 0; i < pco.size(); i++) {
			sb.append("                                                     <tr role=\"row\" class=\"odd\">\r\n"
					+ "                                                         <td class=\"sorting_1\">"
					+ pco.get(i).get("AD_TITLE") + "</td>\r\n"
					+ "                                                         <td>" + pco.get(i).get("AD_DATE")
					+ "</td>");
	...
	private String makeHTMLTrainerProfile(HashMap<String, String> pt, List<HashMap<String, String>> pto) {
		...
		for (int i = 0; i < pto.size(); i++) {
			sb.append("                                                            <tr role=\"row\"  class=\"odd\">"
					+ "                                                                <td class=\"sorting_1\">"
					+ pto.get(i).get("AD_TITLE") + "(" + pto.get(i).get("OP_NAME") + ")" + "</td>"
					+ "																 <td>" + pto.get(i).get("AD_ADDR")
					+ " " + pto.get(i).get("C_BNAME") + "</td>"
					+ "                                                                <td>"
					+ pto.get(i).get("OP_PERIOD") + "</td>");
			// success-초록색 : 완료 info-보라색 : 모집중 danger-빨간색 : 만료됨
	...
	private String makeHTMLTrainerProfile(Map<String, String> tp, List<Map<String, String>> tpo, List<Map<String, String>> tpc) {
	  ...
	  sb.append(
				...
				"                </div>\r\n"+
			  	...
			  	"			</div>\r\n");
>>>>>>> 69ba75dfdb19abfa8258bc27c62dbf8079b7bfc4
		return sb.toString();
	}
...
<<<<<<< HEAD
		sb.append("<div class=\"row w-100 mx-0\">\r\n" + "          <div class=\"col-lg-4 mx-auto\">\r\n"
				...
				+ "                      </span>\r\n" + "                    </div>\r\n"
				+ "                    <input type=\"email\" name=\"m_id\" class=\"form-control form-control-lg border-left-0\" value='"
				+ mb.getM_id() + "' disabled>\r\n" + "                  </div>\r\n" + "                </div>\r\n"
				+ "                <div class=\"form-group\">\r\n" + "                </div>\r\n"
				+ "                <div class=\"form-group\">\r\n"
				+ "                    <div class=\"input-group\">\r\n"
				...
				+ "                      </span>\r\n" + "                    </div>\r\n"
				+ "                    <input type=\"text\"  name=\"m_name\" class=\"form-control form-control-lg border-left-0\"value='"
				+ mb.getM_name() + "' disabled>\r\n" + "                  </div>\r\n" + "                </div>\r\n"
				+ "                <div class=\"form-group\">\r\n" + "                  <div class=\"input-group\">\r\n"
				+ "                    <div class=\"input-group-prepend bg-transparent\">\r\n"
				+ "                      <span class=\"input-group-text bg-transparent border-right-0\">\r\n"
				+ "                        <i class=\"mdi mdi-cellphone text-primary\"></i>\r\n"
				+ "                      </span>\r\n" + "                    </div>\r\n"
				+ "                    <input type=\"tel\"  name=\"m_phone\" class=\"form-control form-control-lg border-left-0\" value=\"전화번호: "
				+ mb.getM_phone() + "\">\r\n" + "                  </div>\r\n" + "                </div> \r\n"
				+ "                <div class=\"form-group\">\r\n" + "                  <div class=\"input-group\">\r\n"
				+ "                    <input type=\"text\"  name=\"m_birth\" class=\"form-control form-control-lg border-left-0\" value=\"생년월일 :"
				+ mb.getM_birth() + "\"  disabled>\r\n" + "                  </div>\r\n" + "                </div> \r\n"
	...
	private String makeHTMLDetailPage(Map<String, String> dp, List<OpCategory> opCateList,
			List<Map<String, String>> dibsList, HttpSession session) {
		StringBuilder sb = new StringBuilder();
...
<<<<<<< HEAD
		...
		for (int i = 0; i < opCateList.size(); i++) {// 반복문 돌려서 옵션명 찍어주기
			sb.append("<option id='op" + opCateList.get(i).getOp_code() + "'>" + opCateList.get(i).getOp_name()
					+ "</option>\r\n");
		}

		for (int i = 0; i < opCateList.size(); i++) {// 옵션코드 리스트, 옵션가격 리스트 뽑아내기
			sb.append("<input type=\"hidden\" id='" + opCateList.get(i).getOp_code() + "' value='"
					+ opCateList.get(i).getOp_price() + "'/>");
		}
		sb.append("                                            </select>\r\n"
				+ "                                        </p>\r\n"
				+ "                                        <div class=\"row\">\r\n"
		...
		for (int i = 0; i < opCateList.size(); i++) {// 반복문 돌려서 트레이너 + 담당 카테고리 찍어주기
			...
			// {
			sb.append("<a class='dropdown-item'>" + opCateList.get(i).getM_name() + "  "
					+ opCateList.get(i).getOp_category() + "</a>\r\n");
			// }
		}
		sb.append("</div>");
		// 찜버튼시작
		...
		String delBtn = "<a class=\"btn btn-default\" role=\"button\">" + "<button id='" + "dibsDelete" + ad_code
				+ "' type=\"button\" class=\"btn btn-outline-danger btn-rounded btn-icon\">"
		...
		sb.append(
				"<button id='purchase' class=\"btn btn-primary\" role=\"button\" disabled='true'>구매</button> </div>\r\n"
						+
						// "</form>"+
						"                                    </div>\r\n" + "                                </div>\r\n"
						+ "                            </div>\r\n" + "                        </div>\r\n"
